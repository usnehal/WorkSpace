...
with open(workspace_path + '/saved_model/image_features_extract_model.json', 'r') as json_file:
    json_savedModel= json_file.read()
image_features_extract_model = tf.keras.models.model_from_json(json_savedModel)
image_features_extract_model.load_weights(workspace_path + '/saved_model/image_features_extract_model.h5')
